...
ROOT_URLCONF = 'issueTrackerREST.urls'
...
WSGI_APPLICATION = 'issueTrackerREST.wsgi.application'
...
REPORT_SCHEDULE_SECONDS = config('REPORT_SCHEDULE_SECONDS', cast=float, default=0)
